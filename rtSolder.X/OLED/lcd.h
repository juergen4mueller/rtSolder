...
extern uint8_t buffer[SSD1306_BUFFERSIZE];
...
void fb_draw_char_big (uint16_t x, uint16_t y, const char fIndex);
void fb_draw_char_super_big (uint16_t x, uint16_t y, uint16_t fIndex);

void fb_draw_string (uint16_t x, uint16_t y, const char *pS);
void fb_draw_string_big (uint16_t x, uint16_t y, const char *pS);
void fb_draw_string_big_small_numbers (uint16_t x, uint16_t y, const char *pS);
//void fb_draw_string_super_big (uint16_t x_offset_px, uint16_t y_offset_page, const char *pS);
